...
from app import settingManager
...
class Window(MainWindow):
    ...
    def compute_piOrder(self,orderType):
        ...
        if bond is not None:
            ...
            orders,order=computer.calculate(bond)
    ...
    def openFile(self):
        """打开log/out文件"""
        filePath,fileType=QFileDialog.getOpenFileName(self,"打开文件") # 选择文件名
        ...
        # self.currentFile=self.files[key]
        self.addInfo(f'open {filePath}')
        self.update()
        self.setting.set('')
