...
"}")
        ...
        self.pageTabs = QFrame(self.splitter)
        self.pageTabs.setObjectName(u"pageTabs")
        self.pageTabs.setFrameShape(QFrame.StyledPanel)
        self.pageTabs.setFrameShadow(QFrame.Raised)
        self.splitter.addWidget(self.pageTabs)
