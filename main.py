...
class App:
    ...
    def init_component(self):
        ...
        self.logWindow.tag_config('BO',foreground='#2a6e3f')
        self.logWindow.tag_config('BO1',foreground='#2e59a7')
        self.logWindow.tag_config('BO2',foreground='#6f94cd')
        self.logWindow.tag_config('FV',foreground='#c12c1f')
